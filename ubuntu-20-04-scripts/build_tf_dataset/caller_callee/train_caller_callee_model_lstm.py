...
vocabulary = pickle_lib.get_pickle_file_content(user_home_path + '/base/save_dir/' + 'tfrecord/' + 'vocabulary_list.pickle')

###load max-sequence-length 
max_seq_length = pickle_lib.get_pickle_file_content(user_home_path + '/base/save_dir/' + 'tfrecord/' + 'max_seq_length.pickle')
